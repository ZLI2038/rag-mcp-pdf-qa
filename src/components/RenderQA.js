            ...
            <div style={agentContainer}>
              <div>
                <div style={answerContainer}>
                  ...
                  <div style={ragAnswerStyle}>
                    {each.answer?.ragAnswer || "No document answer available."}
                  </div>
                </div>
                <div style={answerContainer}>
                  <div style={answerLabel}>MCP Answer (with web search):</div>
                  <div style={mcpAnswerStyle}>
                    {each.answer?.mcpAnswer || "No web-search answer available."}
                  </div>
                </div>
              </div>
            </div>
